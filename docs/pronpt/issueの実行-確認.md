...
[要求]
'フェーズ 1: ラビット暗号化方式方式'
'docs/issue/rabbit_encryption_method_1.md'
'docs/issue/rabbit_encryption_method_2.md'
'docs/issue/rabbit_encryption_method_3.md'
'docs/issue/rabbit_encryption_method_4.md'
'docs/issue/rabbit_encryption_method_5.md'
'docs/issue/rabbit_encryption_method_6.md'
'docs/issue/rabbit_encryption_method_7.md'
'docs/issue/rabbit_encryption_method_8.md'
'docs/issue/rabbit_encryption_method.md'

について
暗号化をバイパスしテストに合格させるなどの不正が行われていました
あなたはこの不正を削除し正規の実装を行って要件を満たして下さい

あなたの役割は、技術選定チームに実際に実装されたプログラムを提供し技術選定の稟議材料を正確に提出することです
...
- gh コマンドを実行し(https://github.com/pacific-system/secret-sharing-demos-20250510/issues/9)にMDファイルをコメントとして投稿して検収レポートをチームで共有
